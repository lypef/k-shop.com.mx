...
class WebhookTest extends BaseTest
{
  ...
  public static $url = array("url" => "https://www.example.com/my_listener");
  ...
  public function testSuccesfulWebhookCreate()
  {
    ...
    $webhook->update(array("url" => "https://www.example.com/my_listener"));
    $this->assertTrue(strpos($webhook->webhook_url, "https://www.example.com/my_listener") !== false);
    $webhook->delete();
  }
}
